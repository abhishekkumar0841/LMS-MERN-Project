...
//   console.log("COURSE_DETAILS IN ADD_LECTURE", courseDetails);
  ...
  return (
    <HomeLayout>
      <div className=" flex  items-center text-white gap-10 mx-16 justify-center min-h-[90vh]">
        <div className=" flex flex-col p-2 gap-5 shadow-[0_0_10px_black] w-96 rounded-lg">
          <header className=" flex items-center justify-center relative">
            <button
              onClick={() => navigate(-1)}
              className=" absolute left-2 text-xl text-gray-500"
            >
              <AiOutlineArrowLeft />
            </button>
          ...
          <form onSubmit={onFormSubmit} className=" flex flex-col gap-3">
            ...
            {
                userInput.videoSrc ? (
                    <video src={userInput.videoSrc} controls controlsList="nodownload nofullscreen" disablePictureInPicture muted className=" object-fill rounded-tl-lg rounded-tr-lg w-full" ></video>
                ) : (
